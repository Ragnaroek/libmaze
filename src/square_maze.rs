...
static N_NBS: [WallDirection; 3] = [
    WallDirection::EAST,
    WallDirection::SOUTH,
    WallDirection::WEST,
];
static E_NBS: [WallDirection; 3] = [
    WallDirection::NORTH,
    WallDirection::SOUTH,
    WallDirection::WEST,
];
static S_NBS: [WallDirection; 3] = [
    WallDirection::NORTH,
    WallDirection::EAST,
    WallDirection::WEST,
];
static W_NBS: [WallDirection; 3] = [
    WallDirection::NORTH,
    WallDirection::EAST,
    WallDirection::SOUTH,
];

static ALL_NBS: [WallDirection; 4] = [
    WallDirection::NORTH,
    WallDirection::EAST,
    WallDirection::SOUTH,
    WallDirection::WEST,
...
impl SquareMaze {
    ...
    pub fn new_filled_with_entry_exit(
        width: usize,
        height: usize,
        entry: MazeCell,
        exit: MazeCell,
